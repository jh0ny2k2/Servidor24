<?php
    ...
    class VistaLogIn {
        ...
        public static function render() {
            ...
            echo '          <label for="usuario" class="col-sm-2 col-form-label">Email</label>';
            ...
            echo '          </div>';
            echo '      </div>';
            echo '      <button type="submit" name="accion" value="recibirFormularioInicioSesion" class="btn btn-primary">Iniciar Sesion</button>';
            echo '  </form>';
