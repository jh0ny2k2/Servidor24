                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Crear Contraseña</h3></div>
                                    <div class="card-body">
                                        <form action="controlador.php" method="POST">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="contraseña" name="contraseña" type="password" placeholder="Create a password" />
                                                        <label for="contraseña">Contraseña</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="confirmarContraseña" name="confirmarContraseña" type="password" placeholder="Confirm password" />
