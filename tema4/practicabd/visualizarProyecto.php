                    ...
                    <div class="container-fluid">
                        <div class="row ">
                            <div class="col-lg-12 bg-light border rounded mb-5">
                                <h2 class="title-1 m-b-25">Visualización de Proyecto</h2>
<?php
    $visualiza = visualizarProyectos($_GET['id']);
    echo '                      <h4>Nombre ' . $visualiza['nombre']. '</h4>';
    echo '                      <h4>Descripcion ' . $visualiza['decripcion']. '</h4>';
    echo '                      <h4>Departamento ' . $visualiza['departamento']. '</h4>';
    echo '                      <h4>Fecha Inicio ' . $visualiza['nombre']. '</h4>';
    echo '                      <h4>Fecha Entrega ' . $visualiza['nombre']. '</h4>';
    echo '                      <h4>Estado ' . $visualiza['nombre']. '</h4>';
    echo '                      <h4>Salario ' . $visualiza['nombre']. '</h4>';
?>
                            </div>
                        </div>
                    </div>
